...
const pastData = data.events.filter(e => e.date<data.currentDate)
...
createCards(pastData, "template", "cards")

//Crear los Checkbox de Categorias de forma dinámica 

let arrayCategories = pastData.map(e => e.category).reduce((acc, category)=>
...
$filters.addEventListener("change", function(){
  ...
  if (!text == ""){
    filteredData = filterByCategory(pastData,text)
  }
  else{
